          ...
          <div className="flex flex-col gap-4">
            {isAdmin && (
              <form onSubmit={handleSendAnnouncement} className="flex flex-col gap-3 rounded-2xl border border-border bg-card p-4 shadow-sm">
                ...
                <input type="hidden" name="targetAudience" value="all" />
                <button
                  type="submit"
                  disabled={submitting}
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            {ann.image_url && (
                              <img
                                ...
                                className="mt-2.5 w-auto max-h-60 rounded-xl object-contain"
                              />
                            )}
            ...
            {isAdmin && (
              <form onSubmit={handleSendAnnouncement} className="flex flex-col gap-3 rounded-2xl border border-border bg-card p-4 shadow-sm">
                <h2 className="text-sm font-bold text-foreground flex items-center gap-2">
                  ...
                  Send Broadcast (To Faculty & Admin Only)
                </h2>
                <div>
                  <label className="text-xs font-semibold text-muted-foreground">Title</label>
                  <input
                ...
                <input type="hidden" name="targetAudience" value="faculty_admin" />
                <button
                  type="submit"
                  disabled={submitting}
                ...
                >
                  {submitting ? <Loader2 className="h-4 w-4 animate-spin" /> : <Send className="h-4 w-4" />}
                  Send Only to Faculty and Admin
                </button>
              </form>
            )}
